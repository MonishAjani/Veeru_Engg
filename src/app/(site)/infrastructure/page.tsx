        ...
        <div className="container">
          <div className="prose prose-invert max-w-none">
            <div className="relative mb-12">
              ...
              <div className="pl-10">
                <h2 className="text-2xl font-semibold mb-6 inline-block bg-clip-text text-transparent bg-gradient-blue">State-of-the-Art Facilities</h2>
            ...
            <div className="relative mb-12">
              ...
              <div className="pl-10">
                <h2 className="text-2xl font-semibold mb-6 mt-12 inline-block bg-clip-text text-transparent bg-gradient-blue">Machinery & Equipment</h2>
                <div className="h-1 w-20 bg-gradient-blue rounded mb-6"></div>
                <p className="mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 my-8">
              <div className="bg-gradient-card rounded-xl p-6 shadow-lg transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl relative overflow-hidden group">
                {/* Decorative elements */}
                ...
                <div className="flex items-center mb-6">
                  <div className="w-10 h-10 rounded-lg bg-gradient-blue flex items-center justify-center mr-4 shadow-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-semibold">Mechanical Machinery</h3>
                </div>
                
                <div className="overflow-x-auto relative z-10">
                  <table className="responsive-table">
                    <thead>
                      <tr className="bg-gradient-metal">
                        <th className="py-3 px-4 font-semibold text-white border-b border-steel-600">Machinery</th>
                        <th className="py-3 px-4 font-semibold text-white text-center border-b border-steel-600">QTY.</th>
                      </tr>
                    </thead>
                  ...
                  <div className="mt-6 text-center">
                    <button
                      ...
                      className="group relative px-6 py-3 bg-gradient-blue text-white rounded-md shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg"
                    >
              ...
              <div className="bg-gradient-card rounded-xl p-6 shadow-lg transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl relative overflow-hidden group">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold">Civil Machinery</h3>
                </div>
            ...
            <div className="relative mb-12">
              ...
              <div className="pl-10">
                <h2 className="text-2xl font-semibold mb-6 mt-12 inline-block bg-clip-text text-transparent bg-gradient-blue">Workforce</h2>
                <div className="h-1 w-20 bg-gradient-blue rounded mb-6"></div>
                <p className="mb-6">
      ...
      <h3 className="text-xl font-semibold">Staff List</h3>
                ...
                <div className="overflow-x-auto">
                  <table className="responsive-table">
                    <thead>
                      <tr className="bg-gradient-metal">
                        <th className="py-3 px-4 font-semibold text-white border-b border-steel-600">Name Of Manpower</th>
                        <th className="py-3 px-4 font-semibold text-white text-center border-b border-steel-600">QTY.</th>
                      </tr>
                    </thead>
                    <tbody className="text-steel-300">
              ...
              <div className="bg-gradient-card rounded-xl p-6 shadow-lg transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl relative overflow-hidden group">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold">Worker List</h3>
                </div>
            ...
            <div className="my-16 py-10 px-8 bg-gradient-card rounded-xl shadow-lg relative overflow-hidden">
              ...
              <h3 className="text-2xl font-semibold mb-8 text-center">Our Capabilities at a Glance</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center transform transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-steel-300">Years of Experience</div>
                </div>
                ...
                <div className="text-center transform transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-steel-300">Skilled Workforce</div>
                </div>
                ...
                <div className="text-center transform transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-steel-300">Heavy Machinery</div>
                </div>
